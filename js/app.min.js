...
var cards = [
		...
		<div class="profile-info">
			<table>
				<tbody>
					...
					<tr><td>Profession</td><td>Computer Engineer</td></tr>
    ...
    html: `
			<table>
				<tbody>
					...
					<tr><td>Web Developer Intern</td><td>Vowtech Technologies PVT. LTD.</td><td><a href="#" onclick="modal(event)" data-title="Web Developer Intern">Full Report</a></td></tr>
					<tr><td>Seeking For New One..!</td><td>On Immediate Notice Period</td><td><a href="#" onclick="modal(event)" data-title="New Mission">Full Report</a></td></tr>
				</tbody>
			</table>
		`,
  },
  ...
  },
  {
    ...
    html: `<table>
			<tbody>
				...
				<tr><td width="50%">JavaScript</td><td>Bootstrap</td></tr>
				<tr><td>Django</td><td>Flask</td></tr>
				<tr><td>MATLAB</td><td>Tensor Flow</td></tr>
  ...
  },
  {
    ...
    html: `<table>
        ...
        <tr><td>Business Intelligence</td><td>Generative AI</td></tr>
        <tr><td>UI/UX Design</td><td>Machine Learning</td></tr>
        <tr><td>Cloud Computing</td><td>Git / GitHub</td></tr>
        <tr><td> Data Analytics</td><td>Data Visualization</td></tr>
        <tr><td>API Creation / Integration</td><td>Testing / Automation</td></tr>
        <tr><td>Project Management</td><td>Teamwork</td></tr>
...
var missions = {
  "New Mission": `
		...
		<h3>Role</h3>
		<p>Any in CS / IT Department</p>


	<h3>About Me</h3>

	<p>▪ Aspiring AI & ML Engineer with a strong foundation in C and Python, specializing in Machine Learning and Generative AI. Also proficient in some technologies like HTML, CSS, JavaScript, Django framework, and MySQL, with basic domain knowledge of cloud computing & DBMS. I bring a blend of technical expertise and innovative thinking to develop cutting-edge solutions. Passionate about leveraging AI to solve real-world problems and drive technological advancements.</p>
  ...
  "Web Developer Intern": `
	...
	<p>▪ Task: Built a stock market forecasting system using LSTM, SVM with different kernels (linear, polynomial, and RBF),
and XGBoost models to predict DAX index trends, improving forecast accuracy and better investment decisions</p>
    <p>▪ Preprocessed historical stock data, fine-tuned hyperparameters, and evaluated each model, achieving optimal
performance metrics for time series predictions in financial analytics.</p>
  ...
  "Research Intern": `
	...
	<p>▪ Task: : Designed a Quantum Machine Learning model using Quantum Convolutional Neural Networks (QCNN) for image
classification, improving accuracy by 20% and computational efficiency by 30%.</p>
    <p>▪ Benchmarked QCNN against LeNet-5 CNN using the MNIST dataset, highlighting advantages of quantum circuits in
processing speed and accuracy for complex visual data.</p>
